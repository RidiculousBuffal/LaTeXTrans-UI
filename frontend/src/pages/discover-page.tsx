        ...
        {paper ? (
          <div className="flex flex-col gap-4">
            <div className="rounded-xl border bg-muted/30 p-4">
              <p className="font-medium">{paper.title_zh ?? paper.title_en}</p>
              {paper.title_zh ? (
                <p className="mt-1 text-sm text-muted-foreground">{paper.title_en}</p>
              ) : null}
            ...
            {availableCollections.length === 0 ? (
              ...
              <FieldGroup>
                ...
                <Field>
                  ...
                  <FieldContent>
                    <Select value={translateDecision} onValueChange={(value) => setTranslateDecision(value as TranslateDecision)}>
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              {paper.title_zh ? (
                <CardDescription className="text-sm">{paper.title_en}</CardDescription>
              ) : null}
            </div>
          </div>
          <div className="text-right text-xs text-muted-foreground">
            <p>{paper.arxiv_id}</p>
            <p>{paper.source_run_date ?? "Unknown run date"}</p>
          </div>
        </div>
      </CardHeader>
